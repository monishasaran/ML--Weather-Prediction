...
## Algorithm
1.Collect and preprocess weather dataset (temperature, humidity, wind, etc.).
2.Create multiple decision trees using random subsets of data and features.
3.Each tree predicts the weather independently based on input conditions.
4.Combine all predictions using majority voting (classification) or averaging (regression) to get the final result.
## Program:
```
/*
...
## Output:
<img width="688" height="815" alt="image" src="https://github.com/user-attachments/assets/f38f1399-f465-4644-87b9-ac3e02f616ad" />
